...
public class InitialSetup extends TestSetup {
	...
	public void addSeedSwitch(String switchName) throws Exception {
		settings.addSeedSwitch(switchName, switchUserName, switchPassword);
		if (!settings.verifySeedSwitch(switchName, switchUserName, switchPassword)) {
	...
	public void editCollectorTest(@Optional("default-netvisor-collector") String collectorName, String switchName)
			throws Exception {
	...
	public void activateNvosCollectorTest(@Optional("default-netvisor-collector") String collectorName)
			throws Exception {
	 ...
	 * 
	 * @Test(groups={"smoke","regression"},dependsOnMethods={"logintoIA"},
	 * description="Add collector in IA Page") public void
	 * addCollectorTest(String switchName,@Optional("coll1") String
	 * collectorName) throws Exception{
	 * if(!iaIndex.addCollector(collectorName,switchName,user,passwd)) {
	 * printLogs ("error","addCollector","Collector addition failed"); throw new
	 * Exception("Collector addition failed"); } else {
